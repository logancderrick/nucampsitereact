...
const mapDispatchToProps = {
  ...
  // postFeedback: (id, firstname, lastname, phoneNum, email, agree, contactType, feedback) => (postFeedback(id, firstname, lastname, phoneNum, email, agree, contactType, feedback))
};
  ...
  render() {
      const HomePage = () => {
        return (
          ...
          // partners - goes to HomeComponent Render
